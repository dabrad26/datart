...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ba=Object.prototype.hasOwnProperty;function Va(r,a){return r==null?!1:Ba.call(r,a)}var Ja=Va;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Qa=xa,b=Ka,O=Ar;function Ya(r){var a,e,t;if(r==null)return O.call(r);e=r[b],a=Qa(r,b);try{r[b]=void 0}catch{return O.call(r)}return t=O.call(r),a?r[b]=e:delete r[b],t}var Za=Ya;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var De=He,Xe=je,Be=Ce,M;De()?M=Xe:M=Be;var J=M;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ve=g,Je=typeof Uint8Array=="function";function qe(r){return Je&&r instanceof Uint8Array||Ve(r)==="[object Uint8Array]"}var xe=qe;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Bt=q,hr,G,j;Bt===!0?(G=1,j=0):(G=0,j=1);hr={HIGH:G,LOW:j};var Vt=hr;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Jt=V,qt=J,mr=Vt,gr=new qt(1),nr=new Jt(gr.buffer),xt=mr.HIGH,zt=mr.LOW;function Kt(r,a,e,t){return gr[0]=r,a[t]=nr[xt],a[t+e]=nr[zt],a}var Sr=Kt;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var an=q,R;an===!0?R=1:R=0;var en=R;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var tn=V,nn=J,ln=en,Nr=new nn(1),on=new tn(Nr.buffer);function fn(r){return Nr[0]=r,on[ln]}var un=fn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var sn=q,Er,C,D;sn===!0?(C=1,D=0):(C=0,D=1);Er={HIGH:C,LOW:D};var cn=Er;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var $n=V,yn=J,Ur=cn,Pr=new yn(1),ir=new $n(Pr.buffer),pn=Ur.HIGH,_n=Ur.LOW;function bn(r,a){return ir[pn]=r,ir[_n]=a,Pr[0]}var An=bn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Vn=br,Lr=Bn,Jn=Fr;Vn(Lr,"assign",Jn);var qn=Lr;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ei=cr,ti=$r,ni=yr,ii=xr,li=Kr,oi=Yr,fi=pr,ui=_r,vi=En,si=qn,ci=ai,$i=wr,yi=Tr,pi=2220446049250313e-31,_i=2148532223,U=[0,0],P=[0,0];function bi(r,a){var e,t;return r===0||fi(r)||ui(r)?r:(si(U),r=U[0],a+=U[1],a+=ci(r),a<oi?vi(0,r):a>ii?r<0?ti:ei:(a<=li?(a+=52,t=pi):t=1,$i(P),e=P[0],e&=_i,e|=a+ni<<20,t*yi(e,P[1])))}var Ai=bi;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
